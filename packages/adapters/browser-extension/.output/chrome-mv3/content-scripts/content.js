var content=function(){"use strict";var oe=Object.defineProperty;var de=(w,b,$)=>b in w?oe(w,b,{enumerable:!0,configurable:!0,writable:!0,value:$}):w[b]=$;var n=(w,b,$)=>de(w,typeof b!="symbol"?b+"":b,$);var F,_,x,v;function w(s){return s}class b{constructor(t){n(this,"container");n(this,"previouslyFocused",null);n(this,"isActive",!1);n(this,"boundHandleKeyDown");this.container=t,this.boundHandleKeyDown=this.handleKeyDown.bind(this)}getFocusableElements(){const t=["button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])","a[href]",'[tabindex]:not([tabindex="-1"])'].join(", ");return Array.from(this.container.querySelectorAll(t))}handleKeyDown(t){if(t.key!=="Tab")return;const e=this.getFocusableElements();if(e.length===0)return;const a=e[0],r=e[e.length-1],c=this.container.getRootNode()instanceof ShadowRoot?this.container.getRootNode().activeElement:document.activeElement;t.shiftKey?c===a&&(t.preventDefault(),r.focus()):c===r&&(t.preventDefault(),a.focus())}activate(){if(this.isActive)return;this.previouslyFocused=document.activeElement,this.container.addEventListener("keydown",this.boundHandleKeyDown);const t=this.getFocusableElements();t.length>0&&t[0].focus(),this.isActive=!0}deactivate(){this.isActive&&(this.container.removeEventListener("keydown",this.boundHandleKeyDown),this.previouslyFocused&&typeof this.previouslyFocused.focus=="function"&&this.previouslyFocused.focus(),this.previouslyFocused=null,this.isActive=!1)}get active(){return this.isActive}}class ${constructor(t){n(this,"liveRegion");n(this,"shadow");this.shadow=t||null,this.liveRegion=this.createLiveRegion()}createLiveRegion(){const t=document.createElement("div");return t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-atomic","true"),t.style.cssText=`
      position: absolute;
      width: 1px;
      height: 1px;
      padding: 0;
      ...
      white-space: nowrap;
      border: 0;
    `,this.shadow?this.shadow.appendChild(t):document.body.appendChild(t),t}announce(t){this.liveRegion.setAttribute("aria-live","polite"),this.liveRegion.textContent="",setTimeout(()=>{this.liveRegion.textContent=t},100)}announceUrgent(t){this.liveRegion.setAttribute("aria-live","assertive"),this.liveRegion.textContent="",setTimeout(()=>{this.liveRegion.textContent=t},100)}destroy(){this.liveRegion.remove()}}class K{constructor(t=document){n(this,"shortcuts",new Map);n(this,"container");n(this,"boundHandleKeyDown");n(this,"isEnabled",!0);this.container=t,this.boundHandleKeyDown=this.handleKeyDown.bind(this),this.attach()}getShortcutKey(t,e){const a=[];return e!=null&&e.ctrl&&a.push("ctrl"),e!=null&&e.alt&&a.push("alt"),e!=null&&e.shift&&a.push("shift"),e!=null&&e.meta&&a.push("meta"),a.push(t.toLowerCase()),a.join("+")}handleKeyDown(t){if(!this.isEnabled)return;const e=t,a=this.getShortcutKey(e.key,{ctrl:e.ctrlKey,alt:e.altKey,shift:e.shiftKey,meta:e.metaKey}),r=this.shortcuts.get(a);r&&(e.preventDefault(),r.handler())}register(t){const e=this.getShortcutKey(t.key,t.modifiers);this.shortcuts.set(e,t)}unregister(t,e){const a=this.getShortcutKey(t,e);this.shortcuts.delete(a)}enable(){this.isEnabled=!0}disable(){this.isEnabled=!1}attach(){this.container.addEventListener("keydown",this.boundHandleKeyDown)}detach(){this.container.removeEventListener("keydown",this.boundHandleKeyDown)}getShortcuts(){return Array.from(this.shortcuts.values())}}function L(s,t={}){s.setAttribute("role","dialog"),t.modal&&s.setAttribute("aria-modal","true"),t.labelledBy&&s.setAttribute("aria-labelledby",t.labelledBy),t.describedBy&&s.setAttribute("aria-describedby",t.describedBy)}function y(s,t={}){t.label&&s.setAttribute("aria-label",t.label),t.pressed!==void 0&&s.setAttribute("aria-pressed",String(t.pressed)),t.expanded!==void 0&&s.setAttribute("aria-expanded",String(t.expanded)),t.controls&&s.setAttribute("aria-controls",t.controls),t.describedBy&&s.setAttribute("aria-describedby",t.describedBy)}let U=0;function m(s="ap"){return`${s}-${++U}-${Math.random().toString(36).slice(2,8)}`}function E(){return window.matchMedia("(prefers-reduced-motion: reduce)").matches}const N={bgPrimary:"#0a0a0a",bgSecondary:"#111111",bgTertiary:"#1a1a1a",bgOverlay:"rgba(5, 5, 5, 0.92)",accent:"#00e5ff",accentMuted:"rgba(0, 229, 255, 0.15)",accentGlow:"rgba(0, 229, 255, 0.3)",success:"#00ff9d",successMuted:"rgba(0, 255, 157, 0.15)",successGlow:"rgba(0, 255, 157, 0.3)",danger:"#ff2a6d",dangerMuted:"rgba(255, 42, 109, 0.15)",dangerGlow:"rgba(255, 42, 109, 0.3)",warning:"#f59e0b",warningMuted:"rgba(245, 158, 11, 0.15)",textPrimary:"#ffffff",textSecondary:"#e0e0e0",textMuted:"rgba(255, 255, 255, 0.5)",textInverse:"#0a0a0a",borderPrimary:"rgba(255, 255, 255, 0.1)",borderSecondary:"rgba(255, 255, 255, 0.06)",borderAccent:"rgba(0, 229, 255, 0.2)"},G={bgPrimary:"#ffffff",bgSecondary:"#f8f9fa",bgTertiary:"#f0f1f3",bgOverlay:"rgba(255, 255, 255, 0.95)",accent:"#0096b4",accentMuted:"rgba(0, 150, 180, 0.1)",accentGlow:"rgba(0, 150, 180, 0.2)",success:"#00b36b",successMuted:"rgba(0, 179, 107, 0.1)",successGlow:"rgba(0, 179, 107, 0.2)",danger:"#d92662",dangerMuted:"rgba(217, 38, 98, 0.1)",dangerGlow:"rgba(217, 38, 98, 0.2)",warning:"#d97706",warningMuted:"rgba(217, 119, 6, 0.1)",textPrimary:"#111111",textSecondary:"#374151",textMuted:"rgba(0, 0, 0, 0.5)",textInverse:"#ffffff",borderPrimary:"rgba(0, 0, 0, 0.1)",borderSecondary:"rgba(0, 0, 0, 0.06)",borderAccent:"rgba(0, 150, 180, 0.3)"},i={xs:"4px",sm:"8px",md:"12px",lg:"16px",xl:"20px",xxl:"28px",xxxl:"32px"},o={fontFamily:"'SF Mono', 'Menlo', 'Monaco', 'Consolas', monospace",fontFamilySans:"-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif",fontSize:{xs:"10px",sm:"11px",base:"12px",md:"13px",lg:"14px",xl:"16px",xxl:"18px"},fontWeight:{medium:"500",semibold:"600",bold:"700"},lineHeight:{normal:"1.5"},letterSpacing:{wide:"0.5px",wider:"1px",widest:"1.5px"}},h={sm:"4px",md:"6px",lg:"8px",xl:"12px",full:"9999px"},p={duration:{fast:"150ms",normal:"200ms",slow:"300ms",slower:"400ms"},easing:{default:"cubic-bezier(0.4, 0, 0.2, 1)",bounce:"cubic-bezier(0.34, 1.56, 0.64, 1)"}};function M(s){return`
  ...
  `}function B(){return window.matchMedia("(prefers-color-scheme: dark)").matches}function R(s){return s.mode==="system"?B()?"dark":"light":s.mode}function W(s){return s==="dark"?N:G}class j{constructor(t={mode:"system"}){n(this,"config");n(this,"effectiveTheme");n(this,"listeners",new Set);n(this,"mediaQuery",null);n(this,"boundHandleSystemChange");this.config=t,this.effectiveTheme=R(this.config),this.boundHandleSystemChange=this.handleSystemChange.bind(this),typeof window<"u"&&(this.mediaQuery=window.matchMedia("(prefers-color-scheme: dark)"),this.mediaQuery.addEventListener("change",this.boundHandleSystemChange))}handleSystemChange(){if(this.config.mode==="system"){const t=R(this.config);t!==this.effectiveTheme&&(this.effectiveTheme=t,this.notifyListeners())}}notifyListeners(){const t=this.getColors();for(const e of this.listeners)e(this.effectiveTheme,t)}getTheme(){return this.effectiveTheme}getColors(){return W(this.effectiveTheme)}getCSSVariables(){return M(this.getColors())}getConfig(){return{...this.config}}setConfig(t){this.config={...this.config,...t};const e=R(this.config);e!==this.effectiveTheme&&(this.effectiveTheme=e,this.notifyListeners())}subscribe(t){return this.listeners.add(t),()=>{this.listeners.delete(t)}}destroy(){this.mediaQuery&&this.mediaQuery.removeEventListener("change",this.boundHandleSystemChange),this.listeners.clear()}}function O(s,t){const e=document.createElement("style");e.id="ap-theme-vars";const a=()=>{e.textContent=`:host {
      ${t.getCSSVariables()}
    }
    ...
    :host([data-theme="light"]) {
      ${M(G)}
    }`};a(),s.prepend(e);const r=s.host;r.dataset.theme=t.getTheme();const c=t.subscribe(d=>{r.dataset.theme=d,a()});return()=>{c(),e.remove()}}function V(s,t){const e=s==="dark";switch(t){case"modal":return e?"0 0 40px rgba(0, 229, 255, 0.1), 0 0 80px rgba(0, 0, 0, 0.5)":"0 25px 50px rgba(0, 0, 0, 0.15)";case"drawer":return e?"-4px 0 20px rgba(0, 0, 0, 0.5)":"-4px 0 20px rgba(0, 0, 0, 0.1)";case"toast":return e?"0 4px 20px rgba(0, 0, 0, 0.4), 0 0 20px rgba(0, 229, 255, 0.1)":"0 4px 20px rgba(0, 0, 0, 0.1)";default:return"none"}}function X(s){return s==="dark"?`radial-gradient(
    ...
    `}bindEvents(){const e=this.modal.querySelector('[data-action="grant"]'),a=this.modal.querySelector('[data-action="deny"]');e&&(y(e,{label:"Grant lease request"}),e.addEventListener("click",()=>this.handleGrant())),a&&(y(a,{label:"Deny lease request"}),a.addEventListener("click",()=>this.handleDeny()))}renderContent(e){const a=this.modal.querySelector("[data-agent-name]"),r=this.modal.querySelector("[data-scope-list]"),c=this.modal.querySelector("[data-duration]"),d=this.modal.querySelector("[data-reason]"),l=this.modal.querySelector("[data-badge]");a.textContent=e.agentName||"Unknown Agent";const g=e.scopes||[];r.innerHTML=g.length>0?g.map(f=>`<span class="scope-tag" role="listitem">${this.escapeHtml(f)}</span>`).join(""):'<span class="scope-tag" role="listitem">default</span>',c.textContent=this.formatTtl(e.ttl),d.textContent=e.reason||"No reason provided";const u=this.pendingRequests.length;u>0?(l.textContent=`+${u}`,l.classList.add("visible")):l.classList.remove("visible"),this.updateCardStack()}updateCardStack(){this.stackContainer.innerHTML="",this.cardStack=[];const e=Math.min(this.pendingRequests.length,this.config.maxStack-1);for(let a=0;a<e;a++){const r=document.createElement("div");r.className="stack-card",r.style.setProperty("--stack-index",String(a+1)),r.setAttribute("aria-hidden","true"),this.stackContainer.appendChild(r),this.cardStack.push(r)}}getStyles(){const a=E()?"0ms":p.duration.slow;return`
      ...
      .overlay {
        position: fixed;
        inset: 0;
        background: ${X(this.themeManager.getTheme())};
      ...
      .modal {
        ...
        border: 1px solid var(--ap-border-accent);
        border-radius: ${h.xl};
        box-shadow: ${V(this.themeManager.getTheme(),"modal")};
    ...
    `}show(e){super.show(e),this.overlay.classList.remove("fade-out"),this.overlay.classList.add("visible")}hide(e=!1){e?(this.overlay.classList.add("fade-out"),setTimeout(()=>{this.overlay.classList.remove("visible","fade-out"),super.hide(!1)},400)):(this.overlay.classList.remove("visible"),super.hide(!1))}}class S extends z{constructor(e,a){super("agentping-drawer",e,a);n(this,"backdrop");n(this,"drawer");n(this,"statusDot");n(this,"statusText");n(this,"leasesContainer");n(this,"requestsContainer");n(this,"state",{connectionState:"disconnected",activeLeases:[],pendingRequests:[]});n(this,"countdownIntervals",new Map);n(this,"refreshInterval",null);n(this,"ids",{drawer:m("drawer"),title:m("drawer-title"),leases:m("drawer-leases"),requests:m("drawer-requests")});n(this,"onRevoke",()=>{});n(this,"onStateRequest",()=>{});this.host.style.zIndex="2147483646",this.initializeUI()}initializeUI(){const e=document.createElement("style");e.textContent=this.getStyles(),this.shadow.appendChild(e),this.backdrop=document.createElement("div"),this.backdrop.className="drawer-backdrop",this.backdrop.setAttribute("role","presentation"),this.drawer=document.createElement("div"),this.drawer.className="drawer",L(this.drawer,{labelledBy:this.ids.title}),this.drawer.innerHTML=this.getDrawerTemplate(),this.backdrop.appendChild(this.drawer),this.shadow.appendChild(this.backdrop),this.statusDot=this.drawer.querySelector("[data-status-dot]"),this.statusText=this.drawer.querySelector("[data-status-text]"),this.leasesContainer=this.drawer.querySelector("[data-leases-container]"),this.requestsContainer=this.drawer.querySelector("[data-requests-container]"),this.focusTrap=new b(this.drawer),this.bindEvents()}getDrawerTemplate(){return this.config.position,`
    ...
    `).join(""),this.state.activeLeases.forEach(e=>{this.setupCountdown(e)}),this.leasesContainer.querySelectorAll('[data-action="revoke"]').forEach(e=>{const a=e.dataset.token;y(e,{label:"Revoke this lease"}),e.addEventListener("click",()=>{a&&this.onRevoke(a)})})}setupCountdown(e){const a=this.leasesContainer.querySelector(`[data-countdown="${e.token}"]`);if(!a||!e.expiresAt)return;const r=()=>{const d=Math.max(0,e.expiresAt-Date.now());if(a.textContent=this.formatRemaining(d),a.className=d<6e4?"card-value countdown warning":"card-value countdown",d<=0){const l=this.countdownIntervals.get(e.token);l&&(clearInterval(l),this.countdownIntervals.delete(e.token)),this.onStateRequest(g=>this.updateState(g))}};r();const c=setInterval(r,1e3);this.countdownIntervals.set(e.token,c)}formatRemaining(e){if(e<=0)return"00:00";const a=Math.floor(e/1e3),r=Math.floor(a/60),c=a%60;return`${String(r).padStart(2,"0")}:${String(c).padStart(2,"0")}`}renderRequests(){if(this.state.pendingRequests.length===0){this.requestsContainer.innerHTML=`
        <div class="empty-state" role="status">
          <div class="empty-icon" aria-hidden="true">✓</div>
          None pending
        </div>
    ...
    `,this.bindToastEvents(d,e.requestId),this.container.appendChild(d),requestAnimationFrame(()=>{d.classList.add("visible")});const l=setTimeout(()=>{this.dismissToast(e.requestId)},this.autoDismissDelay),g={id:a,lease:e,element:d,timeoutId:l};this.toasts.set(e.requestId,g),this.enforceMaxStack()}bindToastEvents(e,a){const r=e.querySelector('[data-action="grant"]');r&&(y(r,{label:"Grant lease request"}),r.addEventListener("click",l=>{l.stopPropagation(),this.handleToastGrant(a)}));const c=e.querySelector('[data-action="deny"]');c&&(y(c,{label:"Deny lease request"}),c.addEventListener("click",l=>{l.stopPropagation(),this.handleToastDeny(a)}));const d=e.querySelector('[data-action="dismiss"]');d&&d.addEventListener("click",l=>{l.stopPropagation(),this.dismissToast(a)}),e.addEventListener("mouseenter",()=>{const l=this.toasts.get(a);l!=null&&l.timeoutId&&(clearTimeout(l.timeoutId),l.timeoutId=void 0);const g=e.querySelector(".toast-progress-bar");g&&(g.style.animationPlayState="paused")}),e.addEventListener("mouseleave",()=>{const l=this.toasts.get(a);if(l){l.timeoutId=setTimeout(()=>{this.dismissToast(a)},this.autoDismissDelay/2);const g=e.querySelector(".toast-progress-bar");g&&(g.style.animationPlayState="running")}})}handleToastGrant(e){this.onGrant(e),this.removeToast(e,!0)}handleToastDeny(e){this.onDeny(e),this.removeToast(e,!1)}dismissToast(e){this.removeToast(e,!1)}removeToast(e,a){const r=this.toasts.get(e);r&&(r.timeoutId&&clearTimeout(r.timeoutId),r.element.classList.add(a?"exit-grant":"exit-deny"),setTimeout(()=>{r.element.remove(),this.toasts.delete(e),this.toasts.size===0&&(this._isVisible=!1,this.currentRequest=null)},300))}enforceMaxStack(){const e=Array.from(this.container.children),a=e.length-this.config.maxStack;if(a>0)for(let r=0;r<a;r++){const d=e[r].dataset.requestId;d&&this.dismissToast(d)}}getStyles(){const a=E()?"0ms":p.duration.slow;return`
      ${I()}
      ...
      .toast {
        ...
        border: 1px solid var(--ap-border-accent);
        border-radius: ${h.xl};
        box-shadow: ${V(this.themeManager.getTheme(),"toast")};
        width: 100%;
        max-width: 360px;
        overflow: hidden;
        pointer-events: auto;
    ...
    `}registerKeyboardShortcuts(){this.keyboardManager.register({key:"Escape",handler:()=>this.dismissAll(),description:"Dismiss all notifications"}),this.keyboardManager.disable()}dismissAll(){const e=Array.from(this.toasts.keys());for(const a of e)this.dismissToast(a)}show(e){this._isVisible=!0,this.currentRequest=e,this.renderContent(e),this.playSound(),this.keyboardManager.enable(),this.announceToScreenReader(`New lease request from ${e.agentName||"Unknown Agent"}. Scopes: ${(e.scopes||["default"]).join(", ")}.`)}hide(e=!1){this.dismissAll(),this._isVisible=!1,this.currentRequest=null,this.keyboardManager.disable()}get pendingCount(){return this.toasts.size}}const P={position:"right",maxStack:5,soundEnabled:!0,soundVolume:.15};function Z(s,t,e=P){switch(s){case"modal":return new H(t,e);case"drawer":return new S(t,e);case"toast":return new J(t,e);default:return console.warn(`[AgentPing] Unknown notification style: ${s}, falling back to modal`),new H(t,e)}}class ee{constructor(t){n(this,"ui",null);n(this,"themeManager",null);n(this,"config");n(this,"initialized",!1);n(this,"onGrant",()=>{});n(this,"onDeny",()=>{});n(this,"onRevoke",()=>{});n(this,"onStateRequest",()=>{});this.config={style:(t==null?void 0:t.style)||"drawer",notification:{...P,...t==null?void 0:t.notification}}}async initialize(){this.initialized||(this.themeManager=await Q(),this.ui=Z(this.config.style,this.themeManager,this.config.notification),this.ui.onGrant=t=>this.onGrant(t),this.ui.onDeny=t=>this.onDeny(t),this.ui instanceof S&&(this.ui.onRevoke=t=>this.onRevoke(t),this.ui.onStateRequest=t=>this.onStateRequest(t)),this.initialized=!0)}async updateConfig(t){const e=t.style&&t.style!==this.config.style;this.config={style:t.style||this.config.style,notification:{...this.config.notification,...t.notification}},e&&this.initialized&&(this.destroy(),this.initialized=!1,await this.initialize())}show(t){if(!this.ui){console.warn("[AgentPing] NotificationManager not initialized");return}this.ui.show(t)}hide(t=!1){var e;(e=this.ui)==null||e.hide(t)}toggleDrawer(){this.ui instanceof S&&this.ui.toggle()}showDrawer(){this.ui instanceof S&&this.ui.showDrawer()}updateDrawerState(t){this.ui instanceof S&&this.ui.updateState(t)}announce(t){var e;(e=this.ui)==null||e.announceToScreenReader(t)}get isVisible(){var t;return((t=this.ui)==null?void 0:t.isVisible)??!1}get pendingCount(){var t;return((t=this.ui)==null?void 0:t.pendingCount)??0}get style(){return this.config.style}destroy(){var t;(t=this.ui)==null||t.destroy(),this.ui=null,this.initialized=!1}}const te={matches:["<all_urls>"],runAt:"document_idle",async main(){var r,c,d,l,g;const s=await chrome.storage.local.get(["notificationConfig","themeConfig"]),t=((r=s.notificationConfig)==null?void 0:r.style)||"drawer",e={position:((c=s.notificationConfig)==null?void 0:c.position)||"right",maxStack:((d=s.notificationConfig)==null?void 0:d.maxStack)||5,soundEnabled:((l=s.notificationConfig)==null?void 0:l.soundEnabled)??!0,soundVolume:((g=s.notificationConfig)==null?void 0:g.soundVolume)||.15},a=new ee({style:t,notification:e});await a.initialize(),a.onGrant=u=>{chrome.runtime.sendMessage({type:"approveLease",requestId:u})},a.onDeny=u=>{chrome.runtime.sendMessage({type:"denyLease",requestId:u})},a.onRevoke=u=>{chrome.runtime.sendMessage({type:"revokeLease",token:u})},a.onStateRequest=u=>{chrome.runtime.sendMessage({type:"getDrawerState"},f=>{f&&u({connectionState:f.connectionState,activeLeases:f.activeLeases||[],pendingRequests:f.pendingLeases||[]})})},chrome.runtime.onMessage.addListener(u=>{var f;switch(u.type){case"showLeaseOverlay":u.lease&&a.show(u.lease);break;case"hideLeaseOverlay":a.hide(!1);break;case"toggleDrawer":a.toggleDrawer();break;case"showDrawer":a.showDrawer();break;case"updateDrawerState":u.state&&a.updateDrawerState(u.state);break;case"updateConfig":u.config&&a.updateConfig({style:(f=u.config.notification)==null?void 0:f.style,notification:u.config.notification});break}}),chrome.storage.onChanged.addListener(u=>{if(a.style==="drawer"&&a.isVisible&&(u.activeLeases||u.pendingLeases)&&a.onStateRequest(f=>a.updateDrawerState(f)),u.notificationConfig){const f=u.notificationConfig.newValue;f&&a.updateConfig({style:f.style,notification:f})}}),window.addEventListener("unload",()=>{a.destroy()})}};function T(s,...t){}const ae={debug:(...s)=>T(console.debug,...s),log:(...s)=>T(console.log,...s),warn:(...s)=>T(console.warn,...s),error:(...s)=>T(console.error,...s)},C=(_=(F=globalThis.browser)==null?void 0:F.runtime)!=null&&_.id?globalThis.browser:globalThis.chrome;var se=(x=class extends Event{constructor(t,e){super(x.EVENT_NAME,{}),this.newUrl=t,this.oldUrl=e}},n(x,"EVENT_NAME",D("wxt:locationchange")),x);function D(s){var t;return`${(t=C==null?void 0:C.runtime)==null?void 0:t.id}:content:${s}`}function ie(s){let t,e;return{run(){t==null&&(e=new URL(location.href),t=s.setInterval(()=>{let a=new URL(location.href);a.href!==e.href&&(window.dispatchEvent(new se(a,e)),e=a)},1e3))}}}var ne=(v=class{constructor(t,e){n(this,"isTopFrame",window.self===window.top);n(this,"abortController");n(this,"locationWatcher",ie(this));n(this,"receivedMessageIds",new Set);this.contentScriptName=t,this.options=e,this.abortController=new AbortController,this.isTopFrame?(this.listenForNewerScripts({ignoreFirstEvent:!0}),this.stopOldScripts()):this.listenForNewerScripts()}get signal(){return this.abortController.signal}abort(t){return this.abortController.abort(t)}get isInvalid(){var t;return((t=C.runtime)==null?void 0:t.id)==null&&this.notifyInvalidated(),this.signal.aborted}get isValid(){return!this.isInvalid}onInvalidated(t){return this.signal.addEventListener("abort",t),()=>this.signal.removeEventListener("abort",t)}block(){return new Promise(()=>{})}setInterval(t,e){const a=setInterval(()=>{this.isValid&&t()},e);return this.onInvalidated(()=>clearInterval(a)),a}setTimeout(t,e){const a=setTimeout(()=>{this.isValid&&t()},e);return this.onInvalidated(()=>clearTimeout(a)),a}requestAnimationFrame(t){const e=requestAnimationFrame((...a)=>{this.isValid&&t(...a)});return this.onInvalidated(()=>cancelAnimationFrame(e)),e}requestIdleCallback(t,e){const a=requestIdleCallback((...r)=>{this.signal.aborted||t(...r)},e);return this.onInvalidated(()=>cancelIdleCallback(a)),a}addEventListener(t,e,a,r){var c;e==="wxt:locationchange"&&this.isValid&&this.locationWatcher.run(),(c=t.addEventListener)==null||c.call(t,e.startsWith("wxt:")?D(e):e,a,{...r,signal:this.signal})}notifyInvalidated(){this.abort("Content script context invalidated"),ae.debug(`Content script "${this.contentScriptName}" context invalidated`)}stopOldScripts(){window.postMessage({type:v.SCRIPT_STARTED_MESSAGE_TYPE,contentScriptName:this.contentScriptName,messageId:Math.random().toString(36).slice(2)},"*")}verifyScriptStartedEvent(t){var c,d,l;const e=((c=t.data)==null?void 0:c.type)===v.SCRIPT_STARTED_MESSAGE_TYPE,a=((d=t.data)==null?void 0:d.contentScriptName)===this.contentScriptName,r=!this.receivedMessageIds.has((l=t.data)==null?void 0:l.messageId);return e&&a&&r}listenForNewerScripts(t){let e=!0;const a=r=>{if(this.verifyScriptStartedEvent(r)){this.receivedMessageIds.add(r.data.messageId);const c=e;if(e=!1,c&&(t!=null&&t.ignoreFirstEvent))return;this.notifyInvalidated()}};addEventListener("message",a),this.onInvalidated(()=>removeEventListener("message",a))}},n(v,"SCRIPT_STARTED_MESSAGE_TYPE",D("wxt:content-script-started")),v);function le(){}function q(s,...t){}const re={debug:(...s)=>q(console.debug,...s),log:(...s)=>q(console.log,...s),warn:(...s)=>q(console.warn,...s),error:(...s)=>q(console.error,...s)};return(async()=>{try{const{main:s,...t}=te;return await s(new ne("content",t))}catch(s){throw re.error('The content script "content" crashed on startup!',s),s}})()}();
content;