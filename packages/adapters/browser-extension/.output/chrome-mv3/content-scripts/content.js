var content=function(){"use strict";var ce=Object.defineProperty;var ue=(w,b,$)=>b in w?ce(w,b,{enumerable:!0,configurable:!0,writable:!0,value:$}):w[b]=$;var n=(w,b,$)=>ue(w,typeof b!="symbol"?b+"":b,$);var K,U,x,v;function w(s){return s}class b{constructor(t){n(this,"container");n(this,"previouslyFocused",null);n(this,"isActive",!1);n(this,"boundHandleKeyDown");this.container=t,this.boundHandleKeyDown=this.handleKeyDown.bind(this)}getFocusableElements(){const t=["button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])","a[href]",'[tabindex]:not([tabindex="-1"])'].join(", ");return Array.from(this.container.querySelectorAll(t))}handleKeyDown(t){if(t.key!=="Tab")return;const e=this.getFocusableElements();if(e.length===0)return;const a=e[0],r=e[e.length-1],d=this.container.getRootNode()instanceof ShadowRoot?this.container.getRootNode().activeElement:document.activeElement;t.shiftKey?d===a&&(t.preventDefault(),r.focus()):d===r&&(t.preventDefault(),a.focus())}activate(){if(this.isActive)return;this.previouslyFocused=document.activeElement,this.container.addEventListener("keydown",this.boundHandleKeyDown);const t=this.getFocusableElements();t.length>0&&t[0].focus(),this.isActive=!0}deactivate(){this.isActive&&(this.container.removeEventListener("keydown",this.boundHandleKeyDown),this.previouslyFocused&&typeof this.previouslyFocused.focus=="function"&&this.previouslyFocused.focus(),this.previouslyFocused=null,this.isActive=!1)}get active(){return this.isActive}}class ${constructor(t){n(this,"liveRegion");n(this,"shadow");this.shadow=t||null,this.liveRegion=this.createLiveRegion()}createLiveRegion(){const t=document.createElement("div");return t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-atomic","true"),t.style.cssText=`
      position: absolute;
      width: 1px;
      height: 1px;
      padding: 0;
  ...
  `}function j(){return window.matchMedia("(prefers-color-scheme: dark)").matches}function I(s){return s.mode==="system"?j()?"dark":"light":s.mode}function O(s){return s==="dark"?V:P}class X{constructor(t={mode:"system"}){n(this,"config");n(this,"effectiveTheme");n(this,"listeners",new Set);n(this,"mediaQuery",null);n(this,"boundHandleSystemChange");this.config=t,this.effectiveTheme=I(this.config),this.boundHandleSystemChange=this.handleSystemChange.bind(this),typeof window<"u"&&(this.mediaQuery=window.matchMedia("(prefers-color-scheme: dark)"),this.mediaQuery.addEventListener("change",this.boundHandleSystemChange))}handleSystemChange(){if(this.config.mode==="system"){const t=I(this.config);t!==this.effectiveTheme&&(this.effectiveTheme=t,this.notifyListeners())}}notifyListeners(){const t=this.getColors();for(const e of this.listeners)e(this.effectiveTheme,t)}getTheme(){return this.effectiveTheme}getColors(){return O(this.effectiveTheme)}getCSSVariables(){return M(this.getColors())}getConfig(){return{...this.config}}setConfig(t){this.config={...this.config,...t};const e=I(this.config);e!==this.effectiveTheme&&(this.effectiveTheme=e,this.notifyListeners())}subscribe(t){return this.listeners.add(t),()=>{this.listeners.delete(t)}}destroy(){this.mediaQuery&&this.mediaQuery.removeEventListener("change",this.boundHandleSystemChange),this.listeners.clear()}}function Y(s,t){const e=document.createElement("style");e.id="ap-theme-vars";const a=()=>{e.textContent=`:host {
      ${t.getCSSVariables()}
    }
    ...
    :host([data-theme="light"]) {
      ${M(P)}
    }`};a(),s.prepend(e);const r=s.host;r.dataset.theme=t.getTheme();const d=t.subscribe(l=>{r.dataset.theme=l,a()});return()=>{d(),e.remove()}}function A(s,t){const e=s==="dark";switch(t){case"modal":return e?"0 0 40px rgba(0, 229, 255, 0.1), 0 0 80px rgba(0, 0, 0, 0.5)":"0 25px 50px rgba(0, 0, 0, 0.15)";case"drawer":return e?"-4px 0 20px rgba(0, 0, 0, 0.5)":"-4px 0 20px rgba(0, 0, 0, 0.1)";case"toast":return e?"0 4px 20px rgba(0, 0, 0, 0.4), 0 0 20px rgba(0, 229, 255, 0.1)":"0 4px 20px rgba(0, 0, 0, 0.1)";default:return"none"}}function Q(s){return s==="dark"?`radial-gradient(
    ...
    `}bindEvents(){const e=this.modal.querySelector('[data-action="grant"]'),a=this.modal.querySelector('[data-action="deny"]');e&&(y(e,{label:"Grant lease request"}),e.addEventListener("click",()=>this.handleGrant())),a&&(y(a,{label:"Deny lease request"}),a.addEventListener("click",()=>this.handleDeny()))}renderContent(e){const a=this.modal.querySelector("[data-agent-name]"),r=this.modal.querySelector("[data-scope-list]"),d=this.modal.querySelector("[data-duration]"),l=this.modal.querySelector("[data-reason]"),c=this.modal.querySelector("[data-badge]");a.textContent=e.agentName||"Unknown Agent";const g=e.scopes||[];r.innerHTML=g.length>0?g.map(f=>`<span class="scope-tag" role="listitem">${this.escapeHtml(f)}</span>`).join(""):'<span class="scope-tag" role="listitem">default</span>',d.textContent=this.formatTtl(e.ttl),l.textContent=e.reason||"No reason provided";const u=this.pendingRequests.length;u>0?(c.textContent=`+${u}`,c.classList.add("visible")):c.classList.remove("visible"),this.updateCardStack()}updateCardStack(){this.stackContainer.innerHTML="",this.cardStack=[];const e=Math.min(this.pendingRequests.length,this.config.maxStack-1);for(let a=0;a<e;a++){const r=document.createElement("div");r.className="stack-card",r.style.setProperty("--stack-index",String(a+1)),r.setAttribute("aria-hidden","true"),this.stackContainer.appendChild(r),this.cardStack.push(r)}}getStyles(){const a=D()?"0ms":p.duration.slow;return`
      ${R()}
      ...
      .modal {
        ...
        border: 1px solid var(--ap-border-accent);
        border-radius: ${h.xl};
        box-shadow: ${A(this.themeManager.getTheme(),"modal")};
    ...
    `).join(""),this.state.activeLeases.forEach(e=>{this.setupCountdown(e)}),this.leasesContainer.querySelectorAll('[data-action="revoke"]').forEach(e=>{const a=e.dataset.token;y(e,{label:"Revoke this lease"}),e.addEventListener("click",()=>{a&&this.onRevoke(a)})})}setupCountdown(e){const a=this.leasesContainer.querySelector(`[data-countdown="${e.token}"]`);if(!a||!e.expiresAt)return;const r=()=>{const l=Math.max(0,e.expiresAt-Date.now());if(a.textContent=this.formatRemaining(l),a.className=l<6e4?"card-value countdown warning":"card-value countdown",l<=0){const c=this.countdownIntervals.get(e.token);c&&(clearInterval(c),this.countdownIntervals.delete(e.token)),this.onStateRequest(g=>this.updateState(g))}};r();const d=setInterval(r,1e3);this.countdownIntervals.set(e.token,d)}formatRemaining(e){if(e<=0)return"00:00";const a=Math.floor(e/1e3),r=Math.floor(a/60),d=a%60;return`${String(r).padStart(2,"0")}:${String(d).padStart(2,"0")}`}renderRequests(){if(this.state.pendingRequests.length===0){this.requestsContainer.innerHTML=`
        <div class="empty-state" role="status">
          <div class="empty-icon" aria-hidden="true">✓</div>
          None pending
        </div>
    ...
    `).join(""),this.requestsContainer.querySelectorAll('[data-action="grant"]').forEach(e=>{const a=e.dataset.request;y(e,{label:"Grant lease request"}),e.addEventListener("click",()=>{a&&this.onGrant(a)})}),this.requestsContainer.querySelectorAll('[data-action="deny"]').forEach(e=>{const a=e.dataset.request;y(e,{label:"Deny lease request"}),e.addEventListener("click",()=>{a&&this.onDeny(a)})})}renderContent(e){this.state.pendingRequests.some(r=>r.requestId===e.requestId)||this.state.pendingRequests.push(e),this.renderRequests()}getStyles(){const a=D()?"0ms":p.duration.slow,r=this.config.position==="left",d=A(this.themeManager.getTheme(),"drawer");return`
      ${R()}
      ...
      .drawer,
      .drawer * {
        font-family: var(--ap-font-sans, ${o.fontFamilySans});
      }
      ...
      .drawer {
        ...
        border-${r?"right":"left"}: 1px solid var(--ap-border-accent, rgba(0, 229, 255, 0.2));
        box-shadow: ${r?"":"-"}${d.replace(/^-/,"")};
    ...
    `,this.bindToastEvents(l,e.requestId),this.container.appendChild(l),requestAnimationFrame(()=>{l.classList.add("visible")});const c=setTimeout(()=>{this.dismissToast(e.requestId)},this.autoDismissDelay),g={id:a,lease:e,element:l,timeoutId:c};this.toasts.set(e.requestId,g),this.enforceMaxStack()}bindToastEvents(e,a){const r=e.querySelector('[data-action="grant"]');r&&(y(r,{label:"Grant lease request"}),r.addEventListener("click",c=>{c.stopPropagation(),this.handleToastGrant(a)}));const d=e.querySelector('[data-action="deny"]');d&&(y(d,{label:"Deny lease request"}),d.addEventListener("click",c=>{c.stopPropagation(),this.handleToastDeny(a)}));const l=e.querySelector('[data-action="dismiss"]');l&&l.addEventListener("click",c=>{c.stopPropagation(),this.dismissToast(a)}),e.addEventListener("mouseenter",()=>{const c=this.toasts.get(a);c!=null&&c.timeoutId&&(clearTimeout(c.timeoutId),c.timeoutId=void 0);const g=e.querySelector(".toast-progress-bar");g&&(g.style.animationPlayState="paused")}),e.addEventListener("mouseleave",()=>{const c=this.toasts.get(a);if(c){c.timeoutId=setTimeout(()=>{this.dismissToast(a)},this.autoDismissDelay/2);const g=e.querySelector(".toast-progress-bar");g&&(g.style.animationPlayState="running")}})}handleToastGrant(e){this.onGrant(e),this.removeToast(e,!0)}handleToastDeny(e){this.onDeny(e),this.removeToast(e,!1)}dismissToast(e){this.removeToast(e,!1)}removeToast(e,a){const r=this.toasts.get(e);r&&(r.timeoutId&&clearTimeout(r.timeoutId),r.element.classList.add(a?"exit-grant":"exit-deny"),setTimeout(()=>{r.element.remove(),this.toasts.delete(e),this.toasts.size===0&&(this._isVisible=!1,this.currentRequest=null)},300))}enforceMaxStack(){const e=Array.from(this.container.children),a=e.length-this.config.maxStack;if(a>0)for(let r=0;r<a;r++){const l=e[r].dataset.requestId;l&&this.dismissToast(l)}}getStyles(){const a=D()?"0ms":p.duration.slow;return`
      ${R()}
      ...
      .toast {
        ...
        border: 1px solid var(--ap-border-accent);
        border-radius: ${h.xl};
        box-shadow: ${A(this.themeManager.getTheme(),"toast")};
        width: 100%;
        max-width: 360px;
        overflow: hidden;
        pointer-events: auto;
    ...
    `}registerKeyboardShortcuts(){this.keyboardManager.register({key:"Escape",handler:()=>this.dismissAll(),description:"Dismiss all notifications"}),this.keyboardManager.disable()}dismissAll(){const e=Array.from(this.toasts.keys());for(const a of e)this.dismissToast(a)}show(e){this._isVisible=!0,this.currentRequest=e,this.renderContent(e),this.playSound(),this.keyboardManager.enable(),this.announceToScreenReader(`New lease request from ${e.agentName||"Unknown Agent"}. Scopes: ${(e.scopes||["default"]).join(", ")}.`)}hide(e=!1){this.dismissAll(),this._isVisible=!1,this.currentRequest=null,this.keyboardManager.disable()}get pendingCount(){return this.toasts.size}}const F={position:"right",maxStack:5,soundEnabled:!0,soundVolume:.15};function te(s,t,e=F){switch(s){case"modal":return new H(t,e);case"drawer":return new S(t,e);case"toast":return new ee(t,e);default:return console.warn(`[AgentPing] Unknown notification style: ${s}, falling back to modal`),new H(t,e)}}class ae{constructor(t){n(this,"ui",null);n(this,"toolbarDrawer",null);n(this,"themeManager",null);n(this,"config");n(this,"initialized",!1);n(this,"onGrant",()=>{});n(this,"onDeny",()=>{});n(this,"onRevoke",()=>{});n(this,"onStateRequest",()=>{});this.config={style:(t==null?void 0:t.style)||"drawer",notification:{...F,...t==null?void 0:t.notification}}}async initialize(){this.initialized||(this.themeManager=await Z(),this.ui=te(this.config.style,this.themeManager,this.config.notification),this.ui.onGrant=t=>this.onGrant(t),this.ui.onDeny=t=>this.onDeny(t),this.ui instanceof S&&(this.ui.onRevoke=t=>this.onRevoke(t),this.ui.onStateRequest=t=>this.onStateRequest(t)),this.initialized=!0)}async updateConfig(t){var a;const e=t.style&&t.style!==this.config.style;this.config={style:t.style||this.config.style,notification:{...this.config.notification,...t.notification}},(a=this.toolbarDrawer)==null||a.destroy(),this.toolbarDrawer=null,e&&this.initialized&&(this.destroy(),this.initialized=!1,await this.initialize())}updateThemeConfig(t){var e;(e=this.themeManager)==null||e.setConfig(t)}show(t){if(!this.ui){console.warn("[AgentPing] NotificationManager not initialized");return}this.ui.show(t)}hide(t=!1){var e,a;(e=this.ui)==null||e.hide(t),(a=this.toolbarDrawer)==null||a.hide(t)}toggleDrawer(){var t;(t=this.getToolbarDrawer())==null||t.toggle()}showDrawer(){var t;(t=this.getToolbarDrawer())==null||t.showDrawer()}updateDrawerState(t){var e;this.ui instanceof S&&this.ui.updateState(t),(e=this.toolbarDrawer)==null||e.updateState(t)}announce(t){var e;(e=this.ui)==null||e.announceToScreenReader(t)}get isVisible(){var t;return((t=this.ui)==null?void 0:t.isVisible)??!1}get pendingCount(){var t;return((t=this.ui)==null?void 0:t.pendingCount)??0}get style(){return this.config.style}destroy(){var t,e;(t=this.ui)==null||t.destroy(),(e=this.toolbarDrawer)==null||e.destroy(),this.toolbarDrawer=null,this.ui=null,this.initialized=!1}getToolbarDrawer(){return this.ui instanceof S?this.ui:this.themeManager?(this.toolbarDrawer||(this.toolbarDrawer=new S(this.themeManager,this.config.notification),this.toolbarDrawer.onGrant=t=>this.onGrant(t),this.toolbarDrawer.onDeny=t=>this.onDeny(t),this.toolbarDrawer.onRevoke=t=>this.onRevoke(t),this.toolbarDrawer.onStateRequest=t=>this.onStateRequest(t)),this.toolbarDrawer):(console.warn("[AgentPing] NotificationManager not initialized"),null)}}const N="__agentping_webmcp__";function se(){window.addEventListener("message",async s=>{if(s.source!==window)return;const t=s.data;if(!(!t||t.channel!==N)&&t.type==="cdp:execute")try{const e=await chrome.runtime.sendMessage({type:"webmcp:execute-cdp",method:t.cdpMethod,params:t.cdpParams}),a={channel:N,id:t.id,type:"cdp:result",result:e==null?void 0:e.result,error:e==null?void 0:e.error};window.postMessage(a,"*")}catch(e){const a={channel:N,id:t.id,type:"cdp:result",error:e instanceof Error?e.message:String(e)};window.postMessage(a,"*")}})}const ie={matches:["<all_urls>"],runAt:"document_idle",async main(){var r,d,l,c,g;const s=await chrome.storage.local.get(["notificationConfig","agentping_theme_config"]),t=((r=s.notificationConfig)==null?void 0:r.style)||"drawer",e={position:((d=s.notificationConfig)==null?void 0:d.position)||"right",maxStack:((l=s.notificationConfig)==null?void 0:l.maxStack)||5,soundEnabled:((c=s.notificationConfig)==null?void 0:c.soundEnabled)??!0,soundVolume:((g=s.notificationConfig)==null?void 0:g.soundVolume)||.15},a=new ae({style:t,notification:e});await a.initialize(),a.onGrant=u=>{chrome.runtime.sendMessage({type:"approveLease",requestId:u})},a.onDeny=u=>{chrome.runtime.sendMessage({type:"denyLease",requestId:u})},a.onRevoke=u=>{chrome.runtime.sendMessage({type:"revokeLease",token:u})},a.onStateRequest=u=>{chrome.runtime.sendMessage({type:"getDrawerState"},f=>{f&&u({connectionState:f.connectionState,activeLeases:f.activeLeases||[],pendingRequests:f.pendingLeases||[]})})},chrome.runtime.onMessage.addListener(u=>{var f;switch(u.type){case"showLeaseOverlay":u.lease&&a.show(u.lease);break;case"hideLeaseOverlay":a.hide(!1);break;case"toggleDrawer":a.toggleDrawer();break;case"showDrawer":a.showDrawer();break;case"updateDrawerState":u.state&&a.updateDrawerState(u.state);break;case"updateConfig":u.config&&a.updateConfig({style:(f=u.config.notification)==null?void 0:f.style,notification:u.config.notification});break}}),chrome.storage.onChanged.addListener(u=>{var f;if(a.style==="drawer"&&a.isVisible&&(u.activeLeases||u.pendingLeases)&&a.onStateRequest(k=>a.updateDrawerState(k)),u.notificationConfig){const k=u.notificationConfig.newValue;k&&a.updateConfig({style:k.style,notification:k})}(f=u.agentping_theme_config)!=null&&f.newValue&&a.updateThemeConfig(u.agentping_theme_config.newValue)}),se(),window.addEventListener("unload",()=>{a.destroy()})}};function C(s,...t){}const ne={debug:(...s)=>C(console.debug,...s),log:(...s)=>C(console.log,...s),warn:(...s)=>C(console.warn,...s),error:(...s)=>C(console.error,...s)},E=(U=(K=globalThis.browser)==null?void 0:K.runtime)!=null&&U.id?globalThis.browser:globalThis.chrome;var re=(x=class extends Event{constructor(t,e){super(x.EVENT_NAME,{}),this.newUrl=t,this.oldUrl=e}},n(x,"EVENT_NAME",_("wxt:locationchange")),x);function _(s){var t;return`${(t=E==null?void 0:E.runtime)==null?void 0:t.id}:content:${s}`}function oe(s){let t,e;return{run(){t==null&&(e=new URL(location.href),t=s.setInterval(()=>{let a=new URL(location.href);a.href!==e.href&&(window.dispatchEvent(new re(a,e)),e=a)},1e3))}}}var de=(v=class{constructor(t,e){n(this,"isTopFrame",window.self===window.top);n(this,"abortController");n(this,"locationWatcher",oe(this));n(this,"receivedMessageIds",new Set);this.contentScriptName=t,this.options=e,this.abortController=new AbortController,this.isTopFrame?(this.listenForNewerScripts({ignoreFirstEvent:!0}),this.stopOldScripts()):this.listenForNewerScripts()}get signal(){return this.abortController.signal}abort(t){return this.abortController.abort(t)}get isInvalid(){var t;return((t=E.runtime)==null?void 0:t.id)==null&&this.notifyInvalidated(),this.signal.aborted}get isValid(){return!this.isInvalid}onInvalidated(t){return this.signal.addEventListener("abort",t),()=>this.signal.removeEventListener("abort",t)}block(){return new Promise(()=>{})}setInterval(t,e){const a=setInterval(()=>{this.isValid&&t()},e);return this.onInvalidated(()=>clearInterval(a)),a}setTimeout(t,e){const a=setTimeout(()=>{this.isValid&&t()},e);return this.onInvalidated(()=>clearTimeout(a)),a}requestAnimationFrame(t){const e=requestAnimationFrame((...a)=>{this.isValid&&t(...a)});return this.onInvalidated(()=>cancelAnimationFrame(e)),e}requestIdleCallback(t,e){const a=requestIdleCallback((...r)=>{this.signal.aborted||t(...r)},e);return this.onInvalidated(()=>cancelIdleCallback(a)),a}addEventListener(t,e,a,r){var d;e==="wxt:locationchange"&&this.isValid&&this.locationWatcher.run(),(d=t.addEventListener)==null||d.call(t,e.startsWith("wxt:")?_(e):e,a,{...r,signal:this.signal})}notifyInvalidated(){this.abort("Content script context invalidated"),ne.debug(`Content script "${this.contentScriptName}" context invalidated`)}stopOldScripts(){window.postMessage({type:v.SCRIPT_STARTED_MESSAGE_TYPE,contentScriptName:this.contentScriptName,messageId:Math.random().toString(36).slice(2)},"*")}verifyScriptStartedEvent(t){var d,l,c;const e=((d=t.data)==null?void 0:d.type)===v.SCRIPT_STARTED_MESSAGE_TYPE,a=((l=t.data)==null?void 0:l.contentScriptName)===this.contentScriptName,r=!this.receivedMessageIds.has((c=t.data)==null?void 0:c.messageId);return e&&a&&r}listenForNewerScripts(t){let e=!0;const a=r=>{if(this.verifyScriptStartedEvent(r)){this.receivedMessageIds.add(r.data.messageId);const d=e;if(e=!1,d&&(t!=null&&t.ignoreFirstEvent))return;this.notifyInvalidated()}};addEventListener("message",a),this.onInvalidated(()=>removeEventListener("message",a))}},n(v,"SCRIPT_STARTED_MESSAGE_TYPE",_("wxt:content-script-started")),v);function pe(){}function q(s,...t){}const le={debug:(...s)=>q(console.debug,...s),log:(...s)=>q(console.log,...s),warn:(...s)=>q(console.warn,...s),error:(...s)=>q(console.error,...s)};return(async()=>{try{const{main:s,...t}=ie;return await s(new de("content",t))}catch(s){throw le.error('The content script "content" crashed on startup!',s),s}})()}();
content;