var content=function(){"use strict";var le=Object.defineProperty;var ue=(w,b,$)=>b in w?le(w,b,{enumerable:!0,configurable:!0,writable:!0,value:$}):w[b]=$;var n=(w,b,$)=>ue(w,typeof b!="symbol"?b+"":b,$);var K,U,x,v;function w(s){return s}class b{constructor(t){n(this,"container");n(this,"previouslyFocused",null);n(this,"isActive",!1);n(this,"boundHandleKeyDown");this.container=t,this.boundHandleKeyDown=this.handleKeyDown.bind(this)}getFocusableElements(){const t=["button:not([disabled])","input:not([disabled])","select:not([disabled])","textarea:not([disabled])","a[href]",'[tabindex]:not([tabindex="-1"])'].join(", ");return Array.from(this.container.querySelectorAll(t))}handleKeyDown(t){if(t.key!=="Tab")return;const e=this.getFocusableElements();if(e.length===0)return;const a=e[0],r=e[e.length-1],d=this.container.getRootNode()instanceof ShadowRoot?this.container.getRootNode().activeElement:document.activeElement;t.shiftKey?d===a&&(t.preventDefault(),r.focus()):d===r&&(t.preventDefault(),a.focus())}activate(){if(this.isActive)return;this.previouslyFocused=document.activeElement,this.container.addEventListener("keydown",this.boundHandleKeyDown);const t=this.getFocusableElements();t.length>0&&t[0].focus(),this.isActive=!0}deactivate(){this.isActive&&(this.container.removeEventListener("keydown",this.boundHandleKeyDown),this.previouslyFocused&&typeof this.previouslyFocused.focus=="function"&&this.previouslyFocused.focus(),this.previouslyFocused=null,this.isActive=!1)}get active(){return this.isActive}}class ${constructor(t){n(this,"liveRegion");n(this,"shadow");this.shadow=t||null,this.liveRegion=this.createLiveRegion()}createLiveRegion(){const t=document.createElement("div");return t.setAttribute("role","status"),t.setAttribute("aria-live","polite"),t.setAttribute("aria-atomic","true"),t.style.cssText=`
  ...
  `}function j(){return window.matchMedia("(prefers-color-scheme: dark)").matches}function A(s){return s.mode==="system"?j()?"dark":"light":s.mode}function O(s){return s==="dark"?V:H}class X{constructor(t={mode:"system"}){n(this,"config");n(this,"effectiveTheme");n(this,"listeners",new Set);n(this,"mediaQuery",null);n(this,"boundHandleSystemChange");this.config=t,this.effectiveTheme=A(this.config),this.boundHandleSystemChange=this.handleSystemChange.bind(this),typeof window<"u"&&(this.mediaQuery=window.matchMedia("(prefers-color-scheme: dark)"),this.mediaQuery.addEventListener("change",this.boundHandleSystemChange))}handleSystemChange(){if(this.config.mode==="system"){const t=A(this.config);t!==this.effectiveTheme&&(this.effectiveTheme=t,this.notifyListeners())}}notifyListeners(){const t=this.getColors();for(const e of this.listeners)e(this.effectiveTheme,t)}getTheme(){return this.effectiveTheme}getColors(){return O(this.effectiveTheme)}getCSSVariables(){return R(this.getColors())}getConfig(){return{...this.config}}setConfig(t){this.config={...this.config,...t};const e=A(this.config);e!==this.effectiveTheme&&(this.effectiveTheme=e,this.notifyListeners())}subscribe(t){return this.listeners.add(t),()=>{this.listeners.delete(t)}}destroy(){this.mediaQuery&&this.mediaQuery.removeEventListener("change",this.boundHandleSystemChange),this.listeners.clear()}}function Y(s,t){const e=document.createElement("style");e.id="ap-theme-vars";const a=()=>{e.textContent=`:host {
      ${t.getCSSVariables()}
    }
