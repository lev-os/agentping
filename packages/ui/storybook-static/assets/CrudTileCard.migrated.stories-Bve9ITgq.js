import{T as n}from"./TileCard-CsGhJos6.js";import"./iframe-rZoXeK5l.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-CDN07tui.js";import"./card-gzfNK5Fd.js";import"./badge-G0y1RK3D.js";import"./index-B_jtOnfb.js";import"./button-OgTxl8kR.js";import"./index-DBhjKPQa.js";import"./index-DqYXjM1N.js";const g={title:"Migrations/Canonical/Recipes/TileCard",component:n,tags:["autodocs"]},t={args:{item:{id:"1",name:"Agent Alpha",status:"active"},config:{title:"name",subtitle:"status"}}},a={args:{item:{id:"2",name:"Agent Beta",status:"idle"},config:{title:"name",subtitle:"status",avatar:{field:"name",type:"initials"}}}},e={args:{item:{id:"3",name:"Agent Gamma",status:"error",role:"worker"},config:{title:"name",subtitle:"status",badges:[{field:"role",variant:"outline"}]}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    item: {
      id: "1",
      name: "Agent Alpha",
