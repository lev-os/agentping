import{F as t}from"./FieldRenderer-DchKKhuq.js";import"./iframe-CzJrb7DT.js";import"./preload-helper-PPVm8Dsz.js";import"./input-BawzCQYs.js";import"./utils-CDN07tui.js";import"./textarea-DSOyAXy_.js";import"./label-D8f8WTW2.js";import"./index-CJ_imsi-.js";import"./index-WHAuAub8.js";import"./index-Dwoj57sw.js";import"./index-DiN5Zsj0.js";import"./index-Czr-OA3y.js";import"./index-B_jtOnfb.js";const y={title:"Migrations/Canonical/Recipes/FieldRenderer",component:t,tags:["autodocs"]},e={args:{field:{key:"name",label:"Name",type:"text",required:!0},value:"Agent Alpha",onChange:()=>{}}},r={args:{field:{key:"status",label:"Status",type:"select",options:[{label:"Active",value:"active"},{label:"Idle",value:"idle"},{label:"Error",value:"error"}]},value:"active",onChange:()=>{}}},a={args:{field:{key:"name",label:"Name",type:"text",required:!0},value:"",onChange:()=>{},error:"Name is required"}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    field: {
      key: "name",
      label: "Name",
