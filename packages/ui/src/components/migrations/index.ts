/**
 * Migration Barrel - All 416-component migration candidates
 * Auto-generated during Phase 2 migration wave (2026-02-12)
 *
 * Conflict families use named exports to avoid collisions.
 * Canonical aliases and new migrations use export *.
