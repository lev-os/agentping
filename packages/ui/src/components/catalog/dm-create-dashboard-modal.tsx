...
/**
 * DmCreateDashboardModal - Catalog component from dashboard-manager-ui
 * @source packages/dashboard-manager-ui/src/components/CreateDashboardModal.tsx
 * @catalog-status candidate
 * @needs-review Original uses dashboardAPI.createDashboard; catalog component exposes onSubmit prop
 */
