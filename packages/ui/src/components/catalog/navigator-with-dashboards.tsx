...
/**
 * NavigatorWithDashboards — Catalog component from Studio
 *
 * @source packages/studio/src/renderer/components/NavigatorWithDashboards.tsx
 * @catalog-status needs-review — runtime coupled (dashboard-manager API)
 * @category root
 */
...
export interface NavigatorWithDashboardsProps {
  /** Dashboard list (original fetches from API; catalog component accepts as props) */
