...
/**
 * DmDashboardDetail - Catalog component from dashboard-manager-ui
 * @source packages/dashboard-manager-ui/src/components/DashboardDetail.tsx
 * @catalog-status candidate
 * @needs-review Original uses react-router, useWebSocket, dashboardAPI; catalog version is prop-driven
 */
