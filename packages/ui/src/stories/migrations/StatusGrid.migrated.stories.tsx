...
const meta = {
  title: "Migrations/Studio/StatusGrid",
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Raw migration candidate from Studio Storybook. Brought into @kingly/ui unchanged for side-by-side consolidation analysis.",
      },
    },
  },
  tags: ["autodocs"],
