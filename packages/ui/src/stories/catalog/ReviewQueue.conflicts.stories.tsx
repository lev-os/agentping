...
} from "../../components/catalog/code-diff-viewer-conflict";
import {
  ContextMenuCandidate,
  ContextMenuStudioRaw,
  ContextMenuWebUiRaw,
  type ContextMenuAction,
} from "../../components/catalog/context-menu-conflict";
import {
  EmptyStateCandidate,
  EmptyStateStudioRaw,
  EmptyStateWebUiRaw,
} from "../../components/catalog/empty-state-conflict";
import {
  IconButtonCandidate,
  IconButtonStudioRaw,
  IconButtonWebUiRaw,
...
import {
  ...
  TimelineWebUiRaw,
  type TimelineItem,
} from "../../components/catalog/timeline-conflict";
import {
  LogViewerCandidate,
  LogViewerStudioRaw,
  LogViewerWebUiRaw,
  type LogEntry,
} from "../../components/catalog/log-viewer-conflict";
...
const timelineItems: TimelineItem[] = [
  ...
  },
  {
    ...
    detail: "Queue for catalog board review",
    time: "09:42",
    status: "queued",
  },
];
...
const logEntries: LogEntry[] = [
  {
    ...
    timestamp: "09:10:02",
    level: "info",
    message: "UI package: loaded catalog stories",
    source: "storybook",
  },
  {
    id: "2",
...
const meta = {
  title: "Catalog/ReviewQueue/Conflicts",
  parameters: {
    layout: "fullscreen",
    docs: {
      description: {
        component:
          "Conflict review board for catalog artifacts. Each row shows Studio raw, Web-UI raw, and candidate/deferred outcome.",
      },
    },
  },
  tags: ["autodocs"],
  ...
  render: () => (
    <div className="min-h-screen bg-zinc-950 p-6 text-zinc-100">
      <div className="mx-auto max-w-[1400px] space-y-4">
        ...
        <ReviewRow
          family="SearchInput"
          studio={<SearchInputStudioRaw defaultQuery="catalog queue" />}
          webUi={<SearchInputWebUiRaw defaultQuery="catalog queue" />}
          candidate={<SearchInputCandidate defaultQuery="catalog queue" />}
        />
