 ...
 * the GenUI absorption layer from the Component Registry detail page.
 *
      ...
      items: [
        {
          ...
          description: "3-turn, 8-agent architecture decision. BUILD verdict at 0.88 confidence.",
          status: "completed",
        },
        {
          date: "2026-04-01",
